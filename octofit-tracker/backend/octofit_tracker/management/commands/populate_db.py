...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create activities
        activities = [
            Activity(user='Thor', type='Cycling', duration=60, date='2025-04-08'),
            Activity(user='Tony Stark', type='Crossfit', duration=120, date='2025-04-07'),
            Activity(user='Steve Rogers', type='Running', duration=90, date='2025-04-06'),
            Activity(user='Natasha Romanoff', type='Strength', duration=30, date='2025-04-05'),
            Activity(user='Bruce Banner', type='Swimming', duration=75, date='2025-04-04'),
        ]
        ...
        workouts = [
            ...
            Workout(name='Crossfit Training', description='Training for a crossfit competition', duration=120),
